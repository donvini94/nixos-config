...
#
# skills/<name>/ are the lathe skills. Unlike rules, the skill loader accepts a symlinked
...
# They point INTO the nix store because nothing here authors them: they are generated by
# `lathe skills install` at build time, like mcp.json below. lathe itself is installed
# here rather than in cli-tools.nix because that module's premise is packages nixpkgs
# already builds and caches for both platforms, and this one is built from source.
#
